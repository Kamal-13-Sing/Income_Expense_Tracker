...
<!-- --------------------------Income Add in Acount ------------------------ -->
    ...
    <!-- -------------------------Ledger/Table of transaction----------------------- -->
    <div class="trans">
      <?php 
      $query1 = "SELECT * FROM income order by date;";
      $query2 = "SELECT * FROM expense order by date;";
      $run1 = mysqli_query($conn,$query1);
      $run2 = mysqli_query($conn,$query2);
