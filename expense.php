...
if(isset($_POST["submit"])){
  if(!empty($amount)){
  $query = "INSERT INTO expense(category,notes,date,amount)
        VALUES('$category','$notes','$date','$amount');";
        $run = mysqli_query($conn, $query);

//----------------------------------------update-----------------------------
    
        $query3 = "UPDATE income 
...
<!-- --------------------------Income Add in Acount ------------------------ -->
    ...
    <div class="b2 col-6">
      <img class="img-1" src="image/expense.png">
    </div>
    ...
    <a class="bt1 btn btn-primary" href="#"> Transfer </a>
     </div>
     ...
     <div class="input-group mb-4">
        ...
        <br>
          ...
          <br><br>
          Notes <textarea name="note" placeholder="MoMo Chaumin....."></textarea>
          
        </div>
     </div>
     
          <input class="bttn btn btn-primary" type="submit" name="submit" value="Add New Expenses">
          </form>
